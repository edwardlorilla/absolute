...
var update = __webpack_require__(61)("5fc3df78", content, false, {});
    ...
    methods: {
        ...
        onSubmit: function onSubmit() {
            ...
            axios.post('/api/products/' + vm.$route.params.id + '/check-item', jsonObject).then(function (q) {
                vm.$message({
                    message: q.data.product.name + ' has been successfully updated; ',
                    type: 'success'
                });
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "form-group mx-sm-3 mb-2" }, [
      _c("label", { staticClass: "sr-only", attrs: { for: "quantity" } }, [
        _vm._v("Quantity")
      ]),
      _vm._v(" "),
      _c("input", {
  ...
  function() {
    ...
    return _c("div", { staticClass: "form-group mx-sm-3 mb-2" }, [
      _c(
        "label",
        { staticClass: "sr-only", attrs: { for: "manufacture_date" } },
  ...
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "form-group mx-sm-3 mb-2" }, [
      _c("label", { staticClass: "sr-only", attrs: { for: "expiry_date" } }, [
        _vm._v("Expiry Date")
      ]),
      _vm._v(" "),
      _c("input", {
